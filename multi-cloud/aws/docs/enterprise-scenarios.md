...
- **AWS 能力**：CloudTrail organization trail、S3 Object Lock、KMS、CloudWatch Logs、Firehose、Security Lake。
- **Terraform**：`aws_cloudtrail`、`aws_s3_bucket`、`aws_s3_bucket_object_lock_configuration`、`aws_kms_key`、`aws_cloudwatch_log_group`、`aws_kinesis_firehose_delivery_stream`、`aws_securitylake_data_lake`、`aws_securitylake_aws_log_source`。
